                        ...
                        <div key={email.id} className="p-4 border rounded-lg bg-card transition-colors">
                            ...
                            <div className="flex justify-between mb-2 items-center">
                                <div className="flex items-center gap-2">
                                    ...
                                    <Badge variant={email.status === 'sent' ? 'secondary' : (email.status === 'scheduled' ? 'outline' : 'default')} className={email.status === 'draft' ? "bg-blue-500 hover:bg-blue-600" : ""}>
                                        {email.status === 'draft' ? 'READY' : email.status.toUpperCase()}
